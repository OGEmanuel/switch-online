...
const FeatureBox = ({
  ...
  return (
    <div
      className={`lg:pt-[7.5rem] pt-12 overflow-hidden w-full px-4 md:px-10 lg:px-20 ${
        theme === "dark" ? "bg-[#020F0F]" : "bg-white"
      }`}
    >
      <div
        className={`flex flex-col items-center justify-between gap-4 lg:gap-16 ${classes} mx-auto max-w-[1440px]`}
      >
